                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                AuthUserStreamWidget(
                                  builder: (context) => Text(
                                    '${functions.getAgeOfUser(currentUserDocument!.userBirthday!).toString()} years old •  ${valueOrDefault(currentUserDocument?.userLocation, '')}',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          fontFamily: 'Libre Franklin',
                                                ...
                                                child: InkWell(
                                                  ...
                                                  child: wrapWithModel(
                                                    ...
                                                    child:
                                                      ...
                                                      key: Key(
                                                        'Keya26_${listViewPostRecord.reference.id}',
                                                      ),
                                                      postDoc:
                                                          listViewPostRecord
                                                              .reference,
                                ...
                                Padding(
                                  ...
                                  child: AuthUserStreamWidget(
                                    builder: (context) => Builder(
                                      builder: (context) {
                                        final preferences = (currentUserDocument
                                                    ?.userPreferences
                                                    ?.toList() ??
                                                [])
                                            .toList();
                                        return Wrap(
                                          ...
                                          children:
                                              List.generate(preferences.length,
                                                  (preferencesIndex) {
