...
import 'edit_wardrobe_model.dart';
export 'edit_wardrobe_model.dart';

class EditWardrobeWidget extends StatefulWidget {
  const EditWardrobeWidget({Key? key}) : super(key: key);

  @override
  _EditWardrobeWidgetState createState() => _EditWardrobeWidgetState();
}

class _EditWardrobeWidgetState extends State<EditWardrobeWidget> {
  late EditWardrobeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditWardrobeModel());
