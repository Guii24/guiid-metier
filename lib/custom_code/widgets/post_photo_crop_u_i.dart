...
class PostPhotoCropUI extends StatefulWidget {
  const PostPhotoCropUI({
    Key? key,
    this.width,
    this.height,
  ...
  @override
  _PostPhotoCropUIState createState() => _PostPhotoCropUIState();
}

class _PostPhotoCropUIState extends State<PostPhotoCropUI> {
              ...
              onCropped: (image) async {
                ...
                uploadData(path, image).then((value) {
                  FFAppState().update(() {
                    ...
                    FFAppState().addToUploadPhotoPost(value!);
                  });
                  print('image cropped');
