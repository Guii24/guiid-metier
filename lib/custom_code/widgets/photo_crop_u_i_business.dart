...
class PhotoCropUIBusiness extends StatefulWidget {
  const PhotoCropUIBusiness({
    Key? key,
    this.width,
    this.height,
  ...
  @override
  _PhotoCropUIBusinessState createState() => _PhotoCropUIBusinessState();
}

class _PhotoCropUIBusinessState extends State<PhotoCropUIBusiness> {
            ...
            child: Crop(
              ...
              onCropped: (image) async {
                ...
                uploadData(path, image).then((value) {
                  FFAppState().update(() {
                    FFAppState().profilePhotoCompany = value!;
                  });
              ...
              initialAreaBuilder: (rect) => Rect.fromLTRB(
                  rect.left, rect.top + 266, rect.right, rect.top + 546),
