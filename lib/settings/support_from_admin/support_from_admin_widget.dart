...
import 'support_from_admin_model.dart';
export 'support_from_admin_model.dart';

class SupportFromAdminWidget extends StatefulWidget {
  const SupportFromAdminWidget({
    Key? key,
  ...
  @override
  _SupportFromAdminWidgetState createState() => _SupportFromAdminWidgetState();
}

class _SupportFromAdminWidgetState extends State<SupportFromAdminWidget> {
  late SupportFromAdminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SupportFromAdminModel());
                ...
                child: StreamBuilder<List<MessageRecord>>(
                  stream: queryMessageRecord(
                    ...
                    queryBuilder: (messageRecord) =>
                        messageRecord.orderBy('message_time', descending: true),
                  ),
                              ...
                              ListView(
                                ...
                                children: [
                                  SupportCompanentWidget(
                                    key: Key(
                                        'Keyauc_${listViewIndex}_of_${listViewMessageRecordList.length}'),
