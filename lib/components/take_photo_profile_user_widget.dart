...
class _TakePhotoProfileUserWidgetState
    extends State<TakePhotoProfileUserWidget> {
  late TakePhotoProfileUserModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TakePhotoProfileUserModel());
  }
              ...
              children: [
                FFButtonWidget(
                  onPressed: () async {
                    ...
                    _model.result1 = await actions.returnSizeInBytes(
                      _model.uploadedLocalFile1,
                    );
                    if (_model.result1! > 10485760) {
                ...
                FFButtonWidget(
                  onPressed: () async {
                    ...
                    _model.resultgall = await actions.returnSizeInBytes(
                      _model.uploadedLocalFile2,
                    );
                    if (_model.resultgall! > 10485760) {
                      Navigator.pop(context);
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content: Text(
