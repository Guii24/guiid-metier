...
export 'popup_delete_comment_post_model.dart';
...
class _PopupDeleteCommentPostWidgetState
    extends State<PopupDeleteCommentPostWidget> {
  late PopupDeleteCommentPostModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PopupDeleteCommentPostModel());
  }
