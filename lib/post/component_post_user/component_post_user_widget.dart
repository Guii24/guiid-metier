...
export 'component_post_user_model.dart';

class ComponentPostUserWidget extends StatefulWidget {
  const ComponentPostUserWidget({
    Key? key,
  ...
  @override
  _ComponentPostUserWidgetState createState() =>
      _ComponentPostUserWidgetState();
}

class _ComponentPostUserWidgetState extends State<ComponentPostUserWidget> {
  late ComponentPostUserModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ComponentPostUserModel());
  }
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Builder(
                            builder: (context) {
                              final item = containerPostRecord.postCategory
                                  .toList()
                                  .take(3)
                                  .toList();
                              return Row(
