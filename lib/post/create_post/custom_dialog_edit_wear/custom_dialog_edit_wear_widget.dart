...
class _CustomDialogEditWearWidgetState
    extends State<CustomDialogEditWearWidget> {
  late CustomDialogEditWearModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CustomDialogEditWearModel());
