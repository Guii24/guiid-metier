...
import 'component_companies_model.dart';
...
class ComponentCompaniesWidget extends StatefulWidget {
  ...
  @override
  State<ComponentCompaniesWidget> createState() =>
      _ComponentCompaniesWidgetState();
}

class _ComponentCompaniesWidgetState extends State<ComponentCompaniesWidget> {
  late ComponentCompaniesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ComponentCompaniesModel());
  }
