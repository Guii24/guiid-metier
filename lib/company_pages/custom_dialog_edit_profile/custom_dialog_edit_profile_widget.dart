...
class _CustomDialogEditProfileWidgetState
    extends State<CustomDialogEditProfileWidget> {
  late CustomDialogEditProfileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CustomDialogEditProfileModel());
