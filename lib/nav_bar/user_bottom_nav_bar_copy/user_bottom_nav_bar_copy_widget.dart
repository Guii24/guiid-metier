...
import 'user_bottom_nav_bar_copy_model.dart';
export 'user_bottom_nav_bar_copy_model.dart';

class UserBottomNavBarCopyWidget extends StatefulWidget {
  const UserBottomNavBarCopyWidget({Key? key}) : super(key: key);

  @override
  _UserBottomNavBarCopyWidgetState createState() =>
      _UserBottomNavBarCopyWidgetState();
}

class _UserBottomNavBarCopyWidgetState
    extends State<UserBottomNavBarCopyWidget> {
  late UserBottomNavBarCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserBottomNavBarCopyModel());
  }
